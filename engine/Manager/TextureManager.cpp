...
void TextureManager::TransferTexture() {
	...
	mipImages_[SKYDOME] = LoadTexture("engine/resources/Skydome/forest.png");
	...
	mipImages_[ZERO] = LoadTexture("engine/resources/Number/number0.png");
	mipImages_[ONE] = LoadTexture("engine/resources/Number/number1.png");
	mipImages_[TWO] = LoadTexture("engine/resources/Number/number2.png");
	mipImages_[THREE] = LoadTexture("engine/resources/Number/number3.png");
	mipImages_[FOUR] = LoadTexture("engine/resources/Number/number4.png");
	mipImages_[FIVE] = LoadTexture("engine/resources/Number/number5.png");
	mipImages_[SIX] = LoadTexture("engine/resources/Number/number6.png");
	mipImages_[SEVEN] = LoadTexture("engine/resources/Number/number7.png");
	mipImages_[EIGHT] = LoadTexture("engine/resources/Number/number8.png");
	mipImages_[NINE] = LoadTexture("engine/resources/Number/number9.png");
